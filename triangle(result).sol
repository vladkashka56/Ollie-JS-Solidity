...
contract TriangleDraw {
    int256[2][] private bodyPoints = new int256[2][](100);
    uint256 private bp_len = 0;
    int256[2][] private convex = new int256[2][](100);
    uint256 private cv_len = 0;
    int256 private min_X = 100000000;
    int256 private max_X = 0;
